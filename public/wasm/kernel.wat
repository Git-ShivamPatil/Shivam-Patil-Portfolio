(module
 ...
 (type $8 (func (param i32 i32 i32 f64 f64 f64 i32)))
 ...
 (export "renderMandelbrot" (func $assembly/kernel/renderMandelbrot))
 (export "fnv1a" (func $assembly/kernel/fnv1a))
 (export "allocate" (func $assembly/kernel/allocate))
 ...
 (func $assembly/kernel/renderMandelbrot (param $0 i32) (param $1 i32) (param $2 i32) (param $3 f64) (param $4 f64) (param $5 f64) (param $6 i32)
  (local $7 i32)
  (local $8 i32)
  (local $9 i32)
  (local $10 f64)
 ...
 (func $assembly/kernel/fnv1a (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $assembly/kernel/allocate (param $0 i32) (result i32)
  local.get $0
  i32.const 1
