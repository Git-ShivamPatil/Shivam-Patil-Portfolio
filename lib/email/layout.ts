...
<html lang="en">
  ...
  <body style="margin:0;padding:32px 16px;background:#f3f3f3;font-family:Arial,Helvetica,sans-serif;">
    <span style="display:none;font-size:1px;color:#f3f3f3;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;">${previewText}</span>
      ...
      <tr>
        <td align="center">
          <table role="presentation" width="100%" style="max-width:480px;" cellpadding="0" cellspacing="0">
            <tr>
              <td style="padding-bottom:24px;">
                <table role="presentation" cellpadding="0" cellspacing="0">
                  <tr>
                    <td style="width:31px;height:31px;border-radius:50%;background:#111110;text-align:center;vertical-align:middle;font:600 10px Arial,sans-serif;color:#efefef;">SP</td>
            ...
            <tr>
              <td style="background:#ffffff;border:1px solid #d4d4d4;border-radius:16px;padding:32px;">
                ${bodyHtml}
              </td>
            </tr>
            <tr>
              <td style="padding-top:24px;text-align:center;font:400 11px Arial,sans-serif;color:#6c6c6c;">
                shivamsfolio.com
              </td>
            </tr>
          </table>
  ...
  return `<table role="presentation" cellpadding="0" cellspacing="0">
    <tr>
      <td style="border-radius:999px;background:#111110;">
        <a href="${href}" style="display:inline-block;padding:12px 22px;font:700 13px Arial,sans-serif;color:#efefef;text-decoration:none;">${label}</a>
      </td>
    </tr>
  </table>`;
}
