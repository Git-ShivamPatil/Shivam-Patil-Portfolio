...
export const NAVIGATION_COMMANDS: Command[] = [
  { id: "nav-home", label: "Home", href: "/", kind: "navigate", group: "Go to", keywords: "start index landing" },
  { id: "nav-work", label: "Selected work", href: "/#work", kind: "navigate", group: "Go to", keywords: "projects portfolio case studies" },
  { id: "nav-services", label: "Services", href: "/services", kind: "navigate", group: "Go to", keywords: "hire consulting booking rates" },
  { id: "nav-stats", label: "Live stats", href: "/stats", kind: "navigate", group: "Go to", keywords: "github leetcode metrics activity" },
  ...
  { id: "nav-data", label: "Data pipeline", href: "/data", kind: "navigate", group: "Go to", keywords: "duckdb olap sql warehouse etl elt lineage stream" },
  ...
  { id: "nav-achievements", label: "Achievements", href: "/achievements", kind: "navigate", group: "Go to", keywords: "metrics numbers outcomes" },
  { id: "nav-certifications", label: "Certifications", href: "/certifications", kind: "navigate", group: "Go to", keywords: "credentials courses" },
  { id: "nav-resume", label: "Résumé", href: "/resume", kind: "navigate", group: "Go to", keywords: "cv pdf download" },
  { id: "nav-about", label: "About", href: "/about", kind: "navigate", group: "Go to", keywords: "bio who profile" },
  { id: "nav-contact", label: "Contact", href: "/contact", kind: "navigate", group: "Go to", keywords: "email message get in touch" },
  { id: "nav-reach", label: "Reach out", href: "/reach-out", kind: "navigate", group: "Go to", keywords: "channels map location socials" },
  { id: "nav-search", label: "Search", href: "/search", kind: "navigate", group: "Go to", keywords: "find full text" },
];
